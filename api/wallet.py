...
def top_up(account_type, amount, investor_id):
    ...
    wallet_balance.amount = wallet_balance.amount + float(amount)
    topup_add = WalletTopUp(type = account_type, amount = float(amount), investor_id = investor_id, added_at = topped_at)
