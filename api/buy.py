...
def buy_stocks(company_id, investor_id, type, quantity):
    ...
    if quantity > stock_data.number_of_shares:
        ...
        my_share_value = share_price * quantity
        #add to databse
        ...
        stock_data.number_of_shares = stock_data.number_of_shares - quantity
        db.session.commit()
        return render_template('purchase_success.html', message = 'Thank you for your purchase')
